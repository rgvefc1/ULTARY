 ...
 * Generated at: 2020-04-24 12:07:59 UTC
...
public final class ultaryLoginMain_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	String msg = (String)request.getAttribute("msg"); // 그리고 나서 서버에 나타나게 해줘야함
      ...
      out.print( request.getContextPath() );
      out.write("/login.mem\" method=\"post\">\r\n");
      out.write("\t\t\t\t\t<h1 align=\"center\">로그인</h1>\r\n");
      out.write("\t\t\t\t\t\t<hr width=50% color=\"white\">\r\n");
      out.write("\t\t\t\t\t\t<br>\r\n");
      out.write("\t\t\t\t\t\t\t<table  style=\"line-height: 2; height: 130px; width: 220px;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td><input type=\"text\" id=\"memberid\" name=\"memberid\" class=\"input_login\" placeholder=\"아이디\" autofocus required></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td rowspan=\"2\"><button type=button id=\"loginBtn_normal\" class=\"loginBtn_main\" onclick=\"validate();\">로그인</button></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      ...
      out.print(apiURL);
      out.write("\"><img class=\"naverloginBtn\" src=\"");
      out.print( request.getContextPath() );
      ...
      out.write("\t\t\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t\t\t\t</form>\r\n");
      out.write("\t\t\t\t\t\t\t<hr width=10% color=\"white\">\r\n");
      out.write("\t\t\t\t\t\t\t<button type=button id=\"loginBtn_normal_insertmember\" class=\"loginBtn\" onclick=\"gomemberJointerm();\"> 일반 회원 가입</button>\r\n");
      out.write("\t\t\t\t\t\t\t<br>\r\n");
      out.write("\t\t\t\t\t\t\t<br>\r\n");
      out.write("\t\t\t\t\t\t\t<hr width=50% color=\"white\">\r\n");
      out.write("\t\t\t\t\t\t<br>\r\n");
      ...
      out.write("\t};\r\n");
      out.write("\t\r\n");
      out.write("\t$('#loginBtn_normal').click(function(){\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tvar memberid = $('#memberid');\r\n");
      out.write("\t\tvar password = $('#password');\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tvar validatechk = false;\r\n");
      out.write("\t\t$.ajax({ // 아이디, 비번질문, 비번질문답으로 회원인지 조회\r\n");
      out.write("\t\t\turl: '");
      out.print( request.getContextPath() );
      out.write("/login.mem',\r\n");
      out.write("\t\t\tdata:{memberid: memberid.val(), password: password.val()},\r\n");
      out.write("\t\t\tsuccess: function(data){\r\n");
      out.write("\t\t\t\tconsole.log(data);\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\tif(memberid.val() != null && password.val() != null){\r\n");
      out.write("\t\t\t\t\t\tif(data.trim() == \"fail\"){\r\n");
      out.write("\t\t\t\t\t\t\talert('입력하신 사항이 일치하지 않습니다. 다시 확인해주세요.');\r\n");
      out.write("\t\t\t\t\t\t\tmemberid.focus();\r\n");
      out.write("\t\t\t\t \t\t\t\r\n");
      out.write("\t\t\t\t\t\t}else{\r\n");
      ...
      out.write("\t\t}\r\n");
      out.write("\t\tfunction gomemberJointerm(){ //회원가입 약관동의로 이동\r\n");
      out.write("\t\t\tlocation.href='");
      out.print( request.getContextPath() );
      out.write("/views/main/memberJointermsForm.jsp';\r\n");
      out.write("\t\t}\r\n");
      out.write("\t</script>\r\n");
      out.write("</body>\r\n");
      out.write("</html>");
