...
<html>
  ...
  <%
    ...
    String redirectURI = URLEncoder.encode("http://192.168.10.4:9022/Ultary/callback.jsp", "UTF-8");
    String apiURL;
   ...
   // 네이버에서 받아온정보를 네이버 로그인으로 보낼것임.	     
        ...
        response.sendRedirect("http://192.168.10.4:9022/Ultary/naverlogin.mem");
